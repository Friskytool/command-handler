from models.enums import InteractionType, ApplicationCommandType, ApplicationCommandOptionType
...
class Interaction(object):
    ...
    def __init__(self, *, id, application_id, type, data, guild_id, channel_id, member, user, token, version, message):
        self.id = id
    ...
    def from_json(cls, data):
        ...
        return getattr(cls, cls.CONSTRUCTORS.get(typ, cls.default_constructor), 'default_constructor')(data)
    ...
    def application_command_constructor(cls, data):
        ...
        default.pop('data')
        return cls(
            data=ApplicationCommand.from_json(data['data']),
            **default
        )
...
class ApplicationCommand(object):
    def __init__(self, *, id, name, type, resolved = None, options = []):
        ...
        self.options = [ApplicationCommandOption.from_json(option) for option in options]
...
class ApplicationCommandOption(object):
    def __init__(self, type, name, description, required, choices, options, channel_types, min_value, max_value, autocomplete):
        self.type = type
        self.name = name
